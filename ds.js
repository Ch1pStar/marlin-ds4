...
exports.getType = getType; function getType(dev) { return getTypeAndStyle(dev)[0]; }
...
exports.open = function(dev, opt) {
	...
	for(let i=0,l=aKeys.length;i<l;i++) { gmp.msData[aKeys[i]]=[];
...
function parseDigital(data, gpad, ofs) {
	...
	for(let i=0,l=keys.length,key,dPos,dSub; i<l; i++) {
		key=keys[i]; if(key == 'hat') {
			...
			switch(dSub) {
				case 0: u=true; break;
				case 1: u=true; r=true; break;
				case 2: r=true; break;
				case 3: d=true; r=true; break;
				case 4: d=true; break;
				case 5: d=true; l=true; break;
				case 6: l=true; break;
				case 7: u=true; l=true; break;
			}
